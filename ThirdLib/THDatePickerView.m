...
- (void)configToolView {
    ...
    [saveBtn setTitleColor:toPCcolor(@"#1c98f6") forState:(UIControlStateNormal)];
...
//    [cancelBtn setImage:[UIImage imageNamed:@"icon_revocation1"] forState:UIControlStateNormal];
    ...
    [cancelBtn setTitleColor:toPCcolor(@"#666666") forState:(UIControlStateNormal)];
    ...
    line.frame = CGRectMake(0, 43.5, Screen_W, 0.5);
