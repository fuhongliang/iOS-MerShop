...
- (void)setDataWithModel:(GoodsModel *)model{
    ...
    [self.goodsIcon sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/%@",model.img_path,model.img_name]] placeholderImage:[UIImage imageNamed:@"bnt_photo_moren"]];
